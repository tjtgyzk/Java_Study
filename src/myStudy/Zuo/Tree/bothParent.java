...
public class bothParent {
    ...
    public static TreeNode getBothParent(TreeNode head, TreeNode a, TreeNode b) {
...
//            if (lowestAncestor1(head, o1, o2) != getBothParent(head, o1, o2)) {
//                TreeNode a1 = lowestAncestor1(head,o1,o2);
//                TreeNode a2 = getBothParent(head,o1,o2);
